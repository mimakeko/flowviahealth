...
export function SmsConsentForm() {
  ...
  if (status === "success") return (
    <div role="status" className="rounded-2xl border border-emerald-200 bg-emerald-50 p-6 text-emerald-950">
      ...
      <p className="mt-2 leading-7">Thank you. Your SMS consent request has been received. Flowvia Health will send a confirmation text once SMS service is active.</p>
    </div>
  );
