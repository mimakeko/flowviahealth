      ...
      <div className="container-page">
        <div className="grid gap-10 lg:grid-cols-[.9fr_1.1fr] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <p className="mt-6 text-sm text-slate-500">Review our <Link href="/privacy" className="font-semibold text-blue underline">Privacy Policy</Link> and <Link href="/terms" className="font-semibold text-blue underline">Terms of Service</Link>.</p>
          </div>
          <div className="rounded-[24px] border border-line bg-white p-6 shadow-soft sm:p-9">
            <div className="mb-8 border-b border-line pb-6"><p className="eyebrow">Opt in</p><h2 className="mt-3 text-2xl font-semibold tracking-[-.025em]">Provide your consent</h2><p className="mt-2 text-sm leading-6 text-slate-500">All fields are required. This public demo does not transmit or retain submitted information.</p></div>
            <SmsConsentForm />
          </div>
        </div>
