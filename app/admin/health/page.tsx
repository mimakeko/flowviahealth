...
export default async function AdminHealthPage() {
  ...
  const statusMetrics: Array<{ icon: typeof Activity; metric: HealthMetric }> = [
    ...
    { icon: CalendarClock, metric: { label: "Scheduling ready gate", value: referralIntakeQuality.schedulingReadyGateEnabled ? "Enabled" : "Disabled", tone: referralIntakeQuality.schedulingReadyGateEnabled ? "good" : "warn" } },
    { icon: Database, metric: { label: "Create-visit gate source", value: referralIntakeQuality.schedulingReadyGateSource, tone: "good" } },
    { icon: ShieldCheck, metric: { label: "Referral detail decision workspace", value: referralIntakeQuality.referralDetailDecisionWorkspaceEnabled ? "Enabled" : "Disabled", tone: referralIntakeQuality.referralDetailDecisionWorkspaceEnabled ? "good" : "warn" } },
    { icon: ShieldCheck, metric: { label: "Referral detail create CTA gate", value: referralIntakeQuality.referralDetailCreateCtaGateEnabled ? "Enabled" : "Disabled", tone: referralIntakeQuality.referralDetailCreateCtaGateEnabled ? "good" : "warn" } },
    { icon: ShieldCheck, metric: { label: "Referral detail review-only blocks", value: referralIntakeQuality.referralDetailReviewOnlyBlocksEnabled ? "Enabled" : "Disabled", tone: referralIntakeQuality.referralDetailReviewOnlyBlocksEnabled ? "good" : "warn" } },
    { icon: ShieldCheck, metric: { label: "Referral detail safety guarantees", value: referralIntakeQuality.referralDetailSafetyGuaranteesEnabled ? "Enabled" : "Disabled", tone: referralIntakeQuality.referralDetailSafetyGuaranteesEnabled ? "good" : "warn" } },
    { icon: ShieldCheck, metric: { label: "Duplicate create-visit block", value: referralIntakeQuality.schedulingReadyGateEnabled ? "Enabled" : "Disabled", tone: referralIntakeQuality.schedulingReadyGateEnabled ? "good" : "warn" } },
    { icon: ShieldCheck, metric: { label: "Non-SMS create-visit block", value: referralIntakeQuality.schedulingReadyGateEnabled ? "Enabled" : "Disabled", tone: referralIntakeQuality.schedulingReadyGateEnabled ? "good" : "warn" } },
    { icon: ShieldCheck, metric: { label: "Intake-review create-visit block", value: referralIntakeQuality.schedulingReadyGateEnabled ? "Enabled" : "Disabled", tone: referralIntakeQuality.schedulingReadyGateEnabled ? "good" : "warn" } },
    { icon: ShieldCheck, metric: { label: "Guided visit creation", value: referralIntakeQuality.guidedVisitCreationEnabled ? "Enabled" : "Disabled", tone: referralIntakeQuality.guidedVisitCreationEnabled ? "good" : "warn" } },
    { icon: ShieldCheck, metric: { label: "Manual submit required", value: referralIntakeQuality.manualVisitCreateSubmitRequired ? "Enforced" : "Not enforced", tone: referralIntakeQuality.manualVisitCreateSubmitRequired ? "good" : "warn" } },
    { icon: ShieldCheck, metric: { label: "Auto visit creation", value: referralIntakeQuality.autoVisitCreationEnabled ? "Enabled" : "Disabled", tone: referralIntakeQuality.autoVisitCreationEnabled ? "warn" : "good" } },
    { icon: ShieldCheck, metric: { label: "SMS from visit creation", value: referralIntakeQuality.visitCreateSmsSendingEnabled ? "Enabled" : "Disabled", tone: referralIntakeQuality.visitCreateSmsSendingEnabled ? "warn" : "good" } },
    { icon: ShieldCheck, metric: { label: "Visit-create maps/geocoding/travel-time", value: referralIntakeQuality.visitCreateMapsGeocodingTravelTimeEnabled ? "Enabled" : "Disabled", tone: referralIntakeQuality.visitCreateMapsGeocodingTravelTimeEnabled ? "warn" : "good" } },
