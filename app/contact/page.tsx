...
export const metadata: Metadata = { title: "Contact", description: "Contact Flowvia Health, a healthcare technology platform developed and operated by Onzeon Holdings LLC.", alternates: { canonical: "/contact" }, openGraph: { title: "Contact Flowvia Health", url: "/contact" } };
